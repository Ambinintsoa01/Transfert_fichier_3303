...
public class SousServeur3 {
    ...
    public static void main(String[] args) {
        try {
            ...
            PORT = config.getInt("sub_server3_port"); // Remplacez par le sous-serveur correspondant
            STORAGE_DIR = config.get("sub_server_storage_dir1");
